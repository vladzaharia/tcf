...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visit.date'
        db.add_column(u'tcf14_visit', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 7, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Checkin.date'
        db.add_column(u'tcf14_checkin', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visit.date'
        db.delete_column(u'tcf14_visit', 'date')

        # Deleting field 'Checkin.date'
        db.delete_column(u'tcf14_checkin', 'date')
